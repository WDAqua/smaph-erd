...
public class BindingFeaturePack extends FeaturePack<HashSet<Annotation>> {
	 ...
	 * feature vector (in hashmap form). This vector will containing the max,
	...
	private static HashMap<String, Double> collapseEntitySetFeatures(
			HashSet<Tag> entitySet,
	...
	private static HashMap<String, Double> getFeatures(
		...
		HashMap<String, Double> bindingFeatures = collapseEntitySetFeatures(
				selectedEntities, entityToFeatureVectors);
		...
		*/
		...
		if (annotationRegressorScores != null) {
