...
public class AnnotationFeaturePack extends FeaturePack {
	...
	public AnnotationFeaturePack(Annotation a, String query, EnglishStemmer stemmer,
			...
			HashMap<Tag, String[]> entityToBoldsS1,
			HashMap<Tag, String> entityToTitle) {
		super(getFeaturesStatic(a, query, stemmer, entityFeatures, entityToBoldsS1, entityToTitle));
	}
	...
	private static HashMap<String, Double> getFeaturesStatic(Annotation a, String query, EnglishStemmer stemmer,
		...
		features.put("min_edit_distance_bold_segment", minEDBold(entityToBoldsS1.get(t), segmentStr, null));
		features.put("min_edit_distance_title_segment", SmaphUtils.getMinEditDist(entityToTitle.get(t), segmentStr));
		features.put("min_edit_distance_bold_segment_stemmed", minEDBold(entityToBoldsS1.get(t), segmentStr, stemmer));
